...
const (
	...
	AssistantFileCreateRequestJSONError
	AssistantFileCreateNewRequestError
	AssistantFileCreateSendHTTPRequestError
	AssistantFileCreateReadResponseBodyError
	AssistantFileCreateResponseJSONError
	AssistantFileCreateErrorResponseJSONError
	AssistantFileCreateOpenAIError
	AssistantFileDeleteNewRequestError
	AssistantFileDeleteSendHTTPRequestError
	AssistantFileDeleteReadResponseBodyError
	AssistantFileDeleteResponseJSONError
	AssistantFileDeleteErrorResponseJSONError
	AssistantFileDeleteOpenAIError
	AssistantFileGetListNewRequestError
	AssistantFileGetListSendHTTPRequestError
	AssistantFileGetListReadResponseBodyError
	AssistantFileGetListResponseJSONError
	AssistantFileGetListErrorResponseJSONError
	AssistantFileGetListOpenAIError
	AssistantFileGetNewRequestError
	AssistantFileGetSendHTTPRequestError
	AssistantFileGetReadResponseBodyError
	AssistantFileGetResponseJSONError
	AssistantFileGetErrorResponseJSONError
	AssistantFileGetOpenAIError
	...
	GetMessageFileListGetErrorResponseJSONError
	GetMessageFileListGetOpenAIError
	...
	GetMessageFileGetErrorResponseJSONError
	GetMessageFileGetOpenAIError
